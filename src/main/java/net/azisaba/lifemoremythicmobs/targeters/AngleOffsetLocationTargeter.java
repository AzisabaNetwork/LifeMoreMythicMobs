...
public class AngleOffsetLocationTargeter extends ILocationSelector {
   ...
   public AngleOffsetLocationTargeter(SkillExecutor executor, MythicLineConfig config) {
      ...
      this.baseX = sx != null ? PlaceholderDouble.of(sx) : null;
      this.baseY = sy != null ? PlaceholderDouble.of(sy) : null;
      this.baseZ = sz != null ? PlaceholderDouble.of(sz) : null;
      this.baseYaw = syaw != null ? PlaceholderDouble.of(syaw) : null;
      this.basePitch = spit != null ? PlaceholderDouble.of(spit) : null;
      this.hOffset = PlaceholderDouble.of(config.getString("h", "0"));
      this.vOffset = PlaceholderDouble.of(config.getString("v", "0"));
      this.length = PlaceholderDouble.of(config.getString("len", "1"));
