...
public class ParticleStarEffect extends ParticleEffect implements ITargetedEntitySkill, ITargetedLocationSkill {
   ...
   private void playParticleStarEffect(SkillMetadata data, AbstractLocation center, Collection<AbstractPlayer> audience) {
   ...
   private void drawLine(SkillMetadata data, AbstractLocation from, AbstractLocation to, double interval, Collection<AbstractPlayer> audience) {
   ...
   private void playDirectionalParticleEffect(
      SkillMetadata data, AbstractLocation origin, AbstractLocation target, AbstractLocation spawn, Collection<AbstractPlayer> audience
   ) {
      ...
      if (this.particleData == null) {
         this.particle.sendDirectional(audience, spawn, this.pSpeed.get(data), 1, this.xSpread.get(data), this.vSpread.get(data), this.zSpread.get(data), direction);
      }
   }

   private void playParticleCustomEffect(SkillMetadata data, AbstractLocation target, Collection<AbstractPlayer> audience) {
      super.playParticleEffect(data, target, audience);
   }
}
