...
public class ParticleOrbitalCustomEffect extends ParticleEffect implements ITargetedEntitySkill, ITargetedLocationSkill {
   ...
   private class Animator implements Runnable {
      ...
      public Animator(SkillMetadata data, AbstractEntity entity) {
         ...
         this.task = Schedulers.async().runRepeating(ignored -> this.run(), 0L, ParticleOrbitalCustomEffect.this.interval);
      }
      ...
      public void run() {
         ...
         Collection<AbstractPlayer> audience = ParticleOrbitalCustomEffect.this.audience.get(this.data, this.data.getCaster().getEntity());
